<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"/home/wwwroot/mj2019.qmdmob.com/app/admin/view/category/edit.html";i:1554520763;s:63:"/home/wwwroot/mj2019.qmdmob.com/app/admin/view/common/head.html";i:1554520763;s:63:"/home/wwwroot/mj2019.qmdmob.com/app/admin/view/common/foot.html";i:1554520763;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="admin-main fadeInUp animated">
    ...
    <form class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-4">
                <input type="text" name="catdir" lay-verify="required" value="<?php echo $record['catdir']; ?>" placeholder="<?php echo lang('pleaseEnter'); ?>栏目目录" class="layui-input">
            </div>
            <div class="layui-form-mid layui-word-aux red">*</div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="checkbox" <?php if(in_array($item['group_id'],$record['readgroup'])): ?>checked<?php endif; ?> name="readgroup[<?php echo $i; ?>]" value="<?php echo $item['group_id']; ?>" title="<?php echo $item['title']; ?>">
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="number" name="pagesize" value="<?php echo $record['pagesize']; ?>" class="layui-input">
                </div>
