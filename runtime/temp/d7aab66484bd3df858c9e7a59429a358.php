...
    <div class="right-box">        <h3 class="title-link">首页>网站地图</h3>        <div class="display-box azjc-box">            <?php if(is_array($maps) || $maps instanceof \think\Collection || $maps instanceof \think\Paginator): $i = 0; $__LIST__ = $maps;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>            <ul class="wzdt-link-box">                <li class="wzdt-top"><a href="<?php echo $vo['url']; ?>"><?php echo $vo['name']; ?></a></li>                <?php if(is_array($vo['child']) || $vo['child'] instanceof \think\Collection || $vo['child'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['child'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>                <li class="wzdt-child"><a href="<?php echo $v['url']; ?>"><?php echo $v['name']; ?></a></li>                <?php endforeach; endif; else: echo "" ;endif; ?>            </ul>            <?php endforeach; endif; else: echo "" ;endif; ?>        </div>    </div></div>
        <footer>
