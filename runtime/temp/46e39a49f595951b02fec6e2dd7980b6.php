<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"F:\phpStudy\PHPTutorial\WWW\landisi/app/admin\view\navigation\index.html";i:1556090538;s:67:"F:\phpStudy\PHPTutorial\WWW\landisi/app/admin\view\common\head.html";i:1554520763;s:67:"F:\phpStudy\PHPTutorial\WWW\landisi/app/admin\view\common\foot.html";i:1554520763;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="admin-main layui-anim layui-anim-upbit">
    <fieldset class="layui-elem-field layui-field-title">
        <legend><?php echo lang('navigation'); ?>管理</legend>
    </fieldset>
    <div class="demoTable">
        ...
        <a href="<?php echo url('add'); ?>" class="layui-btn" style="float:right;"><i class="fa fa-plus" aria-hidden="true"></i><?php echo lang('add'); ?><?php echo lang('navigation'); ?></a>
    ...
    layui.use(['table','form'], function() {
        ...
        var tableIn = table.render({
            ...
            cols: [[
                ...
                {field: 'name', title: '名称', width: 200,templet: '#name'},
                {field: 'url', title: '链接', width: 300,templet: '#url'},
                {field: 'pname', title: '上级名称', width: 200,templet: '#pname'},
                {field: 'addtime', title: '<?php echo lang("add"); ?><?php echo lang("time"); ?>',width: 150},
                {field: 'edittime', title: '<?php echo lang("edit"); ?><?php echo lang("time"); ?>',width: 150},
                {field: 'sort', align: 'center', title: '<?php echo lang("order"); ?>', width: 120, templet: '#order'},
                {field: 'status', align: 'center', title: '<?php echo lang("status"); ?>', width: 100, toolbar: '#open'},
        ...
        table.on('tool(list)', function(obj) {
            var data = obj.data;
            if (obj.event === 'del'){
                layer.confirm('您确定要删除该地图吗？', function(index){
        ...
        $('body').on('blur','.list_order',function() {
            ...
            var sort = $(this).val();
            var loading = layer.load(1, {shade: [0.1, '#fff']});
            $.post('<?php echo url("navigationOrder"); ?>',{id:id,sort:sort},function(res){
                layer.close(loading);
                if(res.code === 1){
                    layer.msg(res.msg, {time: 1000, icon: 1});
                    tableIn.reload();
        ...
        $('#delAll').click(function(){
            layer.confirm('确认要删除选中的地图吗？', {icon: 3}, function(index) {
                layer.close(index);
