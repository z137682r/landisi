...
INSERT INTO `clt_config` VALUES (63,'smtp_pwd','ldc2018.com','smtp','0');
...
INSERT INTO `clt_field` VALUES (84,3,'images','多图','',0,0,0,'defaul','','images','images','',0,'',0,1,0);
--
-- 表的结构 `clt_link`
-- 
...
CREATE TABLE `clt_picture` (
  ...
  `vido` varchar(80) NOT NULL DEFAULT '',
...
--
INSERT INTO `clt_picture` VALUES (1,4,1,'admin','模型列表','模型列表','展示网站内容模型，模型是CLTPHP的核心之一。','<p>展示网站内容模型，模型是CLTPHP的核心之一。</p>','0',0,1,0,'',0,1,0,1499761915,1505721389,'/uploads/20170904/f5a33a284f8036c3a086f2829f98599b.png','1','/uploads/20170918/931228d2820dd4c4a099a8d3ea05d949.zip','');
...
INSERT INTO `clt_wx_config` VALUES (2,0,'SHOPWCHAT','{\"appid\":\"111\",\"appsecret\":\"2222\",\"token\":\"333\"}','',1,1497088090,1508118488);
--
...
CREATE TABLE `clt_wx_media_item` (
  ...
  PRIMARY KEY (`id`),
  KEY `id` (`media_id`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=712;

-- 
-- 导出`clt_wx_media_item`表中的数据 `clt_wx_media_item`
--
INSERT INTO `clt_wx_media_item` VALUES (3,3,'多图文','多图文','/uploads/20171010/496e3900c4f016c3bec28dc43439c71f.jpg',0,'多图文','<p>多图文</p>','多图文',0,0);
INSERT INTO `clt_wx_media_item` VALUES (4,3,'多图文二','多图文二','/uploads/20171010/66f5145250efdff13af9c49900ba8e45.jpg',0,'多图文二','<p>多图文二</p>','多图文二',0,0);
INSERT INTO `clt_wx_media_item` VALUES (19,2,'你好11','','',0,'','','',0,0);
INSERT INTO `clt_wx_media_item` VALUES (21,1,'第一篇图文haha','cltphp','/uploads/20171010/6cff1192aadd1c64adc4c58bb3e26cbb.jpg',0,'第一篇图文','<p>第一篇图文第一篇图文第一篇图文第一篇图文第一篇图文</p>','',0,0);
INSERT INTO `clt_wx_media_item` VALUES (22,4,'测试1','','',0,'','','',0,0);
INSERT INTO `clt_wx_media_item` VALUES (23,5,'测试2','','',0,'','','',0,0);
INSERT INTO `clt_wx_media_item` VALUES (24,6,'测试3','','',0,'','','',0,0);
INSERT INTO `clt_wx_media_item` VALUES (25,7,'测试4','','',0,'','','',0,0);
INSERT INTO `clt_wx_media_item` VALUES (31,10,'测试','测试','/uploads/20171016/c0601bbae7b8ab7339a3b65926d4eb49.jpg',0,'测试','<p>测试</p>','测试',0,0);
INSERT INTO `clt_wx_media_item` VALUES (32,10,'测试2','测试2','/uploads/20171016/19250d2d69ceaf15964592e31661057f.jpg',0,'测试2','<p>测试2</p>','测试2',0,0);
INSERT INTO `clt_wx_media_item` VALUES (41,8,'啦啦啦啦','佛挡杀佛','/uploads/20171016/8343920c88e691383f51ae4c80203279.jpg',0,'颠倒是非','<p>的萨福地方<img src=\"/public/uploads/ueditor/image/20171016/1508147980118896.jpg\" title=\"1508147980118896.jpg\" alt=\"business-service-1.4924c7c7.jpg\"/></p>','',0,0);
INSERT INTO `clt_wx_media_item` VALUES (42,8,'的说法撒地方','的说法撒地方','/uploads/20171016/687d3f68a0ab408f66926c886e7ec94a.jpg',0,'士大夫士大夫','<p>大师傅但是发放<img src=\"/public/uploads/ueditor/image/20171016/1508148054988353.jpg\" title=\"1508148054988353.jpg\" alt=\"business-service-2.53f66628.jpg\"/></p>','',0,0);
--
-- 表的结构 `clt_wx_menu`
-- 
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 AVG_ROW_LENGTH=1638 COMMENT='微设置->微店菜单';

-- 
-- 导出`clt_wx_menu`表中的数据 `clt_wx_menu`
--
INSERT INTO `clt_wx_menu` VALUES (20,0,'手册','',0,2,0,'',0,1,1508229001,0);
INSERT INTO `clt_wx_menu` VALUES (21,0,'动态','',0,2,0,'',0,2,1508229027,0);
--
-- 表的结构 `clt_wx_user`
-- 
